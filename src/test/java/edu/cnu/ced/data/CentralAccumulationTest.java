...
class CentralAccumulationTest {
	@Test void countsEachReadoutChannelOncePerEvent(){
		...
		a.add(new CentralEventData(List.of(left,duplicate,right),List.of(),List.of(),List.of(),300));
		a.add(new CentralEventData(List.of(left),List.of(),List.of(),List.of(),100));
