 ...
 * viewer's Visibility checkbox row. The alternating row background and
 * per-cell border that keep a wide, many-column bank easy to read across
 * come from {@link ZebraTable}.
 */
@SuppressWarnings("serial")
public final class BankRowTable extends ZebraTable {
