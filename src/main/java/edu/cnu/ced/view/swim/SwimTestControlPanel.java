 ...
 * a choice of reference surface to stop the swim at (via the shared {@link
 * SurfaceChoicePanel}); and "Swim"/"Clear" buttons. Matches legacy CED's
 * own {@code cnuphys.ced.ced3d.SwimmerControlPanel} in spirit -- a bare
 * parameter form for testing the swimmer/field, independent of any
 * physics event. Its much larger randomized batch-testing apparatus
 * (swim counts, random seeds, charge randomization, success/failure
 * filtering) lives alongside this, in the "Batch" tab, as {@link
 * SwimBatchControlPanel}.
 */
